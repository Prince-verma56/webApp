              ...
              <button
                ...
                <div className="w-4 h-4 flex items-center justify-center flex-shrink-0">
                  <motion.div
                    ...
                    <Globe className={cn("w-4 h-4", showSearch ? "text-[#e1ccc8]" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showSearch && (
                    <motion.span
                      ...
                      className="text-sm overflow-hidden whitespace-nowrap text-[#ceb7b2] flex-shrink-0">
                      Search
                    </motion.span>
                  )}
                </AnimatePresence>
            ...
            <div className="absolute right-3 bottom-3">
              <button
                ...
                className={cn("rounded-full p-2 transition-colors", value
                  ? "bg-[#ffffff]/15 text-[#ecd8d4]"
                  : "bg-white/50 dark:bg-white/5 text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white")}>
